...
class StockModel(models.Model):
    ...
    fifty_day_average = models.DecimalField(max_digits=15, decimal_places=2, null=True, blank=True)
    ...
    regular_market_change_percent = models.DecimalField(max_digits=10, decimal_places=4, null=True, blank=True)
    ...
    def to_dict(self):
        return {
            ...
            'stock_history_updated_at': self.stock_history_updated_at.isoformat() if self.stock_history_updated_at else None,
            'yfinance_data_updated_at': self.yfinance_data_updated_at.isoformat() if self.yfinance_data_updated_at else None,
            ...
            'regular_market_change_percent': float(self.regular_market_change_percent) if self.regular_market_change_percent else None,
        }
