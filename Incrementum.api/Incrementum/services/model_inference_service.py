...
class ModelInferenceService:
    ...
    def __init__(self, model_path=None, metadata_path=None):
        ...
        Args:
            model_path: Path to .keras model file. Defaults to final_model_20260325_141441.keras
            metadata_path: Path to metadata JSON file. Defaults to final_model_20260325_141441_metadata.json
        """
    ...
    def _prepare_features(self, df):
        ...
        if not np.all(np.isfinite(features)):
            raise ValueError("Non-finite values in feature input after normalization")
