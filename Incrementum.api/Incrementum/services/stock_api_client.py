...
class StockAPIClient:
    ...
    def __init__(self):
        self.base_url = getattr(settings, 'STOCK_API_BASE_URL', 'http://localhost:8001')
    ...
    def get_stock_history(self, symbol: str, start_date: str = None, end_date: str = None, 
                         ishourly: bool = None, limit: int = 1000, offset: int = 0) -> Optional[Dict]:
        params = {'limit': limit, 'offset': offset}
        if start_date:
        ...
        return self._make_request('GET', f'/stock/{symbol}/history', params=params)
